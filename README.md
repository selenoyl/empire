...
### PowerShell (Windows)
```powershell
./scripts/build-release.ps1 -Configuration Release -Runtime win-x64 -Version 1.0.0 -PauseOnExit
```
...
- If you launch the `.ps1` by double-click, use `-PauseOnExit` so the window stays open and shows errors/success.
